  ...
  if (!planData || !planData.hasCustomPlan) {
    return (
      <div className="space-y-6 animate-in fade-in duration-500 max-w-4xl mx-auto pb-12 text-[#1E1D1A]">
        {/* Header */}
        <div className="text-center space-y-2 border-b border-[#EFECE3] pb-4">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FAF4D8] border border-[#E8DFB3] text-[#7A6218] text-xs font-semibold tracking-wide uppercase mb-1">
        ...
        {submittingPlan ? (
          <div className="warm-card p-12 bg-white flex flex-col items-center justify-center space-y-6 text-center shadow-lg min-h-[400px]">
            <div className="relative w-20 h-20">
              <div className="absolute inset-0 rounded-full border-4 border-[#FAF4D8] animate-pulse" />
          ...
          <div className="warm-card bg-white flex flex-col overflow-hidden shadow-lg h-[650px] relative border border-[#EFECE3] rounded-3xl">
            {/* Coach Chat Header */}
            <div className="px-6 py-4 border-b border-[#EFECE3] bg-[#FAF9F5] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-[#FAF4D8] border border-[#E8DFB3] flex items-center justify-center text-[#7A6218] relative shadow-inner">
              ...
              <div className="flex items-center gap-3">
                <div className="text-right">
                  ...
                  <span className="text-xs font-bold text-[#7A6218]">
                    Step {chatStep + 1} of 10
                  </span>
                </div>
                
                {/* Visual Progress Bar */}
                <div className="w-20 h-1.5 bg-[#FAF4D8] rounded-full overflow-hidden border border-[#E8DFB3]">
                  <div 
                    className="h-full bg-[#7A6218] transition-all duration-300"
                ...
                {chatStep > 0 && (
                  <button
                    ...
                    className="p-2 rounded-xl bg-white border border-[#ECE9DF] hover:bg-[#FAF9F5] text-[#7C786E] hover:text-[#1E1D1A] transition-all cursor-pointer shadow-sm flex items-center gap-1 text-[10px] font-bold"
            ...
            <div className="flex-1 p-6 overflow-y-auto space-y-4 bg-[#FAF9F6]/30 animate-in fade-in duration-200">
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 shadow-sm ${
                      isAi 
                        ? "bg-[#FAF4D8] border border-[#E8DFB3] text-[#7A6218]" 
                    ...
                    <div className="space-y-1">
                      <div className={`px-4 py-3 rounded-2xl text-xs md:text-sm leading-relaxed shadow-sm ${
                        isAi 
                          ? "bg-white text-[#1E1D1A] border border-[#ECE9DF] rounded-tl-none" 
              ...
              {isTyping && (
                <div className="flex items-start gap-2.5 max-w-[80%] self-start animate-in fade-in duration-200">
                  <div className="w-8 h-8 rounded-full bg-[#FAF4D8] border border-[#E8DFB3] text-[#7A6218] flex items-center justify-center shrink-0 shadow-sm">
                    <Bot className="w-4 h-4" />
                  </div>
                  <div className="px-4 py-3 bg-white border border-[#ECE9DF] rounded-2xl rounded-tl-none shadow-sm flex items-center space-x-1.5 h-[38px]">
            ...
            <div className="px-6 py-4 bg-[#FAF9F5] border-t border-[#EFECE3] space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 animate-in zoom-in-95 duration-200">
                  {(["Beginner", "Intermediate", "Advanced"] as const).map((lvl) => (
                    <button
                      ...
                      className={`p-3 rounded-2xl border bg-white flex flex-col items-center justify-center transition-all cursor-pointer shadow-sm border-[#ECE9DF] hover:border-[#FAF4D8] hover:scale-[1.01]`}
                    >
                ...
                <div className="flex flex-wrap gap-2 animate-in zoom-in-95 duration-200">
                  {[
                    ...
                    <button
                      ...
                      className="py-2.5 px-4 rounded-xl border border-[#ECE9DF] bg-white text-xs font-bold text-[#1E1D1A] hover:border-[#FAF4D8] hover:bg-[#FAF9F5] transition-all cursor-pointer shadow-sm"
                    >
                      {goal}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-3 gap-2.5 animate-in zoom-in-95 duration-200">
                  {[
                    ...
                    <button
                      ...
                      className="py-3 px-2 rounded-2xl border border-[#ECE9DF] bg-white text-xs font-bold text-[#1E1D1A] hover:border-[#FAF4D8] hover:bg-[#FAF9F5] transition-all cursor-pointer text-center shadow-sm"
                    >
                      {num.label}
                    </button>
                  ))}
              ...
              {chatStep === 5 && !isTyping && (
                <div className="space-y-3 animate-in zoom-in-95 duration-200">
                      ...
                      return (
                        <button
                          ...
                          className={`py-1.5 px-3 rounded-lg border text-[11px] font-bold transition-all cursor-pointer ${
                            isSelected
                              ? "bg-[#FAF4D8] text-[#7A6218] border-[#E8DFB3] scale-[1.01]"
                              : "bg-white border-[#ECE9DF] text-[#7C786E] hover:text-[#1E1D1A] hover:border-[#ECE9DF]"
                          }`}
                        >
                          {topic}
                        </button>
                  ...
                  <div className="flex justify-between items-center pt-1.5 border-t border-[#ECE9DF]">
                    <span className="text-[10px] text-[#7C786E] font-medium">
                      Selected: <span className="font-bold text-[#7A6218]">{selectedTopics.length} topics</span>
                    </span>
              ...
              {chatStep === 9 && !isTyping && (
                <div className="space-y-4 animate-in zoom-in-95 duration-200">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 p-4 rounded-2xl bg-white border border-[#ECE9DF] text-xs font-semibold shadow-inner">
                  ...
                  >
                    <Sparkles className="w-4.5 h-4.5 text-[#F5C451]" />
            ...
            <form onSubmit={handleSendTypedMessage} className="p-4 border-t border-[#EFECE3] flex gap-2.5 bg-white">
              <input
                type="text"
                value={typedInput}
                ...
                className="flex-1 py-2.5 px-4 rounded-xl border border-[#ECE9DF] text-xs md:text-sm focus:outline-none focus:border-[#7A6218] transition-colors bg-[#FAF9F5]/40 disabled:bg-[#FAF9F5]/20 disabled:cursor-not-allowed text-[#1E1D1A]"
              />
              <button
                type="submit"
    ...
    <div className="space-y-8 animate-in fade-in duration-500 relative text-[#1E1D1A] max-w-[1360px] mx-auto pb-12">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 pb-2 border-b border-[#EFECE3]">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="px-3.5 py-1.5 rounded-xl bg-white border border-[#ECE9DF] font-bold text-xs text-[#1E1D1A] shadow-sm">
            Points: <span className="text-[#7A6218]">{streakPoints}</span>
          </div>

          <button
            onClick={handleResetPlan}
            className="p-2 rounded-xl bg-white border border-[#ECE9DF] hover:bg-[#FAF9F5] text-[#7C786E] hover:text-[#1E1D1A] transition-all cursor-pointer shadow-sm"
            title="Reset Plan"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-2xl border transition-all flex items-start gap-3 ${
                        isActive
                          ? "bg-[#FAF4D8] border-[#E8DFB3] shadow-sm"
                          : isCompleted
                          ? "bg-[#FAF9F5] border-[#ECE9DF] opacity-75"
                          : "bg-[#FAF9F5]/40 border-[#ECE9DF] opacity-50"
                      }`}
                    >
                      ...
                      <div className="min-w-0">
                        <h4 className={`text-xs font-bold leading-tight ${isActive ? "text-[#7A6218]" : "text-[#1E1D1A]"}`}>
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="warm-card p-6 bg-white space-y-6">
            ...
            {/* Header info */}
            <div className="border-b border-[#EFECE3] pb-4 flex justify-between items-start gap-4">
              <div className="space-y-1">
              ...
              <div className="px-3.5 py-1.5 rounded-xl bg-[#FAF9F5] border border-[#ECE9DF] font-bold text-xs text-[#7C786E]">
            ...
            {generatingProblems ? (
              ...
              <div className="p-8 border-2 border-dashed border-[#ECE9DF] rounded-3xl text-center space-y-5 bg-[#FAF9F5]/50">
                <div className="w-12 h-12 rounded-2xl bg-[#FAF4D8] border border-[#E8DFB3] flex items-center justify-center text-[#7A6218] mx-auto">
                  ...
                  {currentProblems.map((problem) => (
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                        problem.completed
                          ? "bg-[#FAF9F5] border-[#ECE9DF] opacity-75"
                          : "bg-[#FAF9F5] border border-[#ECE9DF] hover:border-[#F5C451] hover:bg-white shadow-sm"
                      }`}
                    >
                        ...
                        <div className="min-w-0 space-y-1">
                          ...
                          <div className="flex items-center gap-3 pt-1">
                            ...
                            <a
                              ...
                              className="text-[9px] text-[#7A6218] hover:underline font-bold uppercase flex items-center gap-1"
                            >
                      ...
                      <div className="flex items-center gap-3 shrink-0 self-end sm:self-center">
                        <span className={`px-2 py-0.5 rounded text-[8px] font-extrabold uppercase tracking-wide border ${
                          problem.difficulty === "Easy"
                            ...
                            ? "text-[#7A6218] bg-[#FAF4D8] border-[#E8DFB3]"
      ...
      {activeSolveProblem && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 md:p-6 animate-in fade-in duration-250">
          <div className="bg-[#FAF6EA] w-full max-w-4xl h-[85vh] rounded-3xl overflow-hidden flex flex-col border border-[#ECE9DF] shadow-2xl relative">
            
            {/* Modal Header */}
            <div className="px-6 py-4 border-b border-[#EFECE3] flex justify-between items-center bg-white">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-[#FAF9F5] border border-[#ECE9DF] flex items-center justify-center text-[#1E1D1A]">
              ...
              <button
                ...
                className="p-1.5 rounded-xl bg-[#FAF9F5] hover:bg-[#FAF6EA] border border-[#ECE9DF] text-[#7C786E] hover:text-[#1E1D1A] transition-colors cursor-pointer"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
              ...
              <div className="w-full md:w-5/12 border-r border-[#EFECE3] p-6 overflow-y-auto space-y-6">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="p-3.5 rounded-2xl bg-[#FAF9F5] border border-[#ECE9DF] space-y-2 text-[11px] font-mono text-[#7C786E]">
                ...
                <div className="space-y-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-3.5 rounded-2xl bg-white border border-[#ECE9DF] hover:border-[#FAF4D8] flex items-center justify-between text-xs font-bold text-[#7A6218] hover:bg-[#FAF9F5] transition-all group"
                  >
              ...
              <div className="flex-1 flex flex-col bg-[#21201D] overflow-hidden">
                ...
                <div className="flex-1 p-4 font-mono text-xs text-white relative">
                  <textarea
                    ...
                    className="w-full h-full bg-transparent resize-none focus:outline-none font-mono text-[#F5C451] border-none leading-relaxed"
                    spellCheck="false"
                  />
                </div>
                ...
                {testOutput.length > 0 && (
                  <div className="h-40 border-t border-[#2D2C28] bg-[#1E1D1A] p-4 font-mono text-[10px] text-zinc-400 overflow-y-auto space-y-1 shadow-inner">
                    <div className="flex items-center gap-1.5 border-b border-zinc-800 pb-1 mb-1 text-zinc-500 font-bold uppercase">
                      <Terminal className="w-3.5 h-3.5 text-[#F5C451]" />
                ...
                <div className="px-6 py-4 border-t border-[#EFECE3] bg-white flex items-center justify-end gap-3">
                  <button
                    onClick={handleRunTests}
                    className="py-2.5 px-4 rounded-xl bg-white border border-[#ECE9DF] text-[#7C786E] hover:text-[#1E1D1A] hover:bg-[#FAF9F5] font-bold text-xs transition-colors cursor-pointer shadow-sm"
                  >
                    Run Tests
                  </button>
