  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 max-w-[1360px] mx-auto pb-12 text-[#1E1D1A]">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 border-b border-[#FDF2F8] pb-6">
        ...
        <div className="flex items-center gap-2 p-1 rounded-full bg-white border border-[#FCE7F3] shrink-0 self-start md:self-auto shadow-sm">
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          {userMode === "new" ? (
            ...
            <div className="warm-card rounded-3xl p-8 text-center relative overflow-hidden flex flex-col justify-center items-center min-h-[480px] space-y-6 bg-white">
              ...
              <div className="absolute w-72 h-72 rounded-full bg-[#ec4899]/5 blur-3xl -top-20 -left-20 pointer-events-none" />

              <div className="max-w-md mx-auto space-y-4 relative z-10">
                <div className="w-16 h-16 rounded-3xl bg-[#FFF5F7] border border-[#FCE7F3] flex items-center justify-center shadow-sm mx-auto text-[#1E1D1A]">
                ...
                <div className="p-4 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] max-w-sm mx-auto shadow-sm">
              ...
              {baselineState === "recording" && (
                <div className="space-y-6 w-full max-w-sm relative z-10 animate-in fade-in zoom-in duration-300">
                  ...
                  <div className="flex justify-center items-center gap-1.5 h-16">
                    {Array.from({ length: 24 }).map((_, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className="w-1 bg-[#ec4899] rounded-full waveform-bar"
                          style={{
                            height: "40px",
                  ...
                  <div className="p-4 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] text-center shadow-sm">
                  ...
                  <div className="p-4 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] text-left max-h-24 overflow-y-auto shadow-sm">
                  ...
                  <div className="flex items-center justify-between border-t border-[#FDF2F8] pt-4">
              ...
              {baselineState === "analyzing" && (
                <div className="space-y-4 animate-pulse">
                  <div className="w-12 h-12 rounded-full bg-[#FCE7F3] border border-[#E8DFB3] flex items-center justify-center mx-auto text-[#be185d] animate-spin">
            ...
            <div className="space-y-6">
              ...
              <div className="warm-card rounded-3xl p-6 relative overflow-hidden bg-white">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-[9px] font-semibold px-2 py-0.5 rounded bg-[#FCE7F3] border border-[#E8DFB3] text-[#be185d]">
                    Tech Explanation
                  </span>
                  <span className="text-[9px] font-semibold px-2 py-0.5 rounded bg-[#FFF5F7] border border-[#FCE7F3] text-[#7C786E]">
                    Limit: 5 minutes
                  </span>
                </div>
              </div>
              ...
              <div className="warm-card rounded-3xl p-8 flex flex-col items-center justify-center min-h-[280px] relative bg-white">
                ...
                <div className="text-center space-y-6 w-full">
                  ...
                  <div className="h-16 flex items-center justify-center gap-1.5">
                    {standupState === "recording" ? (
                      ...
                      <div className="flex items-center gap-1.5 w-full max-w-xs opacity-35 px-4">
                        <div className="h-0.5 flex-1 bg-[#FCE7F3]" />
                  ...
                  {/* Real-time speech-to-text preview */}
                  {standupState === "recording" && (
                    <div className="p-4 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] text-left max-h-24 overflow-y-auto w-full max-w-md mx-auto shadow-sm">
                      <span className="block text-[8px] text-[#7C786E] font-bold uppercase tracking-wider mb-1">Live Transcription</span>
                      <p className="text-xs text-[#1E1D1A] italic font-mono leading-relaxed">
                  ...
                  <div className="flex justify-center items-center">
                    {standupState === "idle" && (
                      <button
                        ...
                        className="w-20 h-20 rounded-full border-4 border-[#FCE7F3] flex items-center justify-center bg-[#FFF5F7] hover:border-[#ec4899] hover:scale-105 transition-all duration-300 group cursor-pointer"
                      >
                    ...
                    {standupState === "recording" && (
                      <button
                        ...
                        className="w-20 h-20 rounded-full border-4 border-[#FCE7F3] flex items-center justify-center bg-[#FFF5F7] hover:border-red-500/40 hover:scale-105 transition-all duration-300 group cursor-pointer"
                      >
                    ...
                    {standupState === "analyzing" && (
                      <div className="w-20 h-20 rounded-full border-4 border-[#E8DFB3] flex items-center justify-center bg-[#FCE7F3] animate-spin">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="warm-card p-6 flex-1 flex flex-col justify-between bg-white">
            {/* Header */}
            <div className="flex items-center justify-between pb-4 border-b border-[#FDF2F8]">
              <span className="text-[10px] text-[#7C786E] font-bold uppercase tracking-wider">AI Speech Diagnostics</span>
              <span className="px-2 py-0.5 rounded bg-[#FCE7F3] border border-[#E8DFB3] text-[8px] text-[#be185d] font-bold uppercase tracking-wider">
                Instant Feed
              </span>
            </div>
            ...
            {standupState === "analyzing" ? (
              ...
              <div className="space-y-6 mt-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <div className="p-4 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] space-y-2 shadow-sm">
              ...
              <div className="my-auto text-center py-12 text-[#7C786E] space-y-4">
                <div className="w-12 h-12 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] flex items-center justify-center mx-auto text-[#7C786E] shadow-sm">
            ...
            <div className="border-t border-[#FDF2F8] pt-4 mt-6 text-center">
      ...
      <div className="border-t border-[#FDF2F8] pt-10 space-y-6">
        <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 warm-card p-6 bg-white">
            <div className="flex items-center justify-between mb-4 border-b border-[#FDF2F8] pb-3">
              ...
              <div className="flex items-center gap-4 text-[9px] font-bold text-[#7C786E] uppercase">
                <div className="flex items-center gap-1">
                  <div className="w-2.5 h-2.5 rounded bg-[#FCE7F3] border border-[#ec4899]" /> Completed
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2.5 h-2.5 rounded bg-white border border-[#2C2B27] animate-pulse" /> Active
                </div>
                <div className="flex items-center gap-1">
                  <div className="w-2.5 h-2.5 rounded bg-[#FFF5F7] border border-[#FCE7F3] text-zinc-400 flex items-center justify-center"><Lock className="w-1.5 h-1.5" /></div> Locked
                </div>
              </div>
            </div>
                ...
                return (
                  <button
                    ...
                    className={`relative aspect-square rounded-xl border font-bold text-xs flex flex-col items-center justify-center transition-all duration-300 select-none ${
                      isCompleted
                        ? "bg-[#FCE7F3] border-[#ec4899] text-[#be185d] hover:shadow-sm cursor-pointer"
                        : isActive
                        ? "bg-white border-[#2C2B27] text-[#2C2B27] shadow-sm animate-pulse cursor-pointer"
                        : "bg-[#FFF5F7] border-[#FCE7F3] text-zinc-400 cursor-not-allowed"
                    } ${
                  ...
                  >
                    <span>D{day.day}</span>
                    {isCompleted && (
                      <span className="text-[8px] font-black text-[#be185d] mt-0.5">{day.score}%</span>
                    )}
                    {day.status === "locked" && (
          ...
          <div className="lg:col-span-4 warm-card p-6 flex flex-col justify-between bg-white">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-[#FDF2F8] pb-3">
                <span className="text-[10px] text-[#7C786E] font-bold uppercase tracking-wider">Node Details</span>
                <span className="px-2 py-0.5 rounded bg-[#FFF5F7] border border-[#FCE7F3] text-[8px] text-[#7C786E] font-bold uppercase tracking-wide">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  {selectedRoadmapDay.score && (
                    <span className="text-xs font-black text-[#be185d]">Score: {selectedRoadmapDay.score}%</span>
                  )}
                </div>
                ...
                {selectedRoadmapDay.status === "completed" ? (
                  <div className="space-y-2 pt-2 border-t border-[#FDF2F8]">
                  ...
                  <div className="pt-2 border-t border-[#FDF2F8] space-y-2">
            ...
            <div className="mt-6 border-t border-[#FDF2F8] pt-4">
...
function ScoreRing({ score, label, colorClass }: ScoreRingProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-1.5 p-3 rounded-2xl bg-[#FFF5F7] border border-[#FCE7F3] text-center flex-1">
