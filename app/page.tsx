  ...
  return (
    <main className="flex-1 flex flex-col justify-center items-center px-4 py-16 relative bg-[#0B0A09] text-zinc-100 min-h-screen">
      ...
      <div className="max-w-xl w-full text-center space-y-8 animate-in zoom-in-95 duration-500 z-10">
        ...
        {error && (
          <div className="p-3.5 rounded-xl bg-red-950/40 border border-red-500/30 text-red-300 text-xs font-semibold max-w-md mx-auto">
            {error}
          </div>
        )}
        ...
        {isAnalyzing ? (
          ...
          <div className="max-w-md w-full bg-zinc-900/40 border border-zinc-800/60 backdrop-blur-md rounded-3xl p-8 text-center flex flex-col items-center justify-center animate-in zoom-in-95 duration-500 min-h-[400px] shadow-xl mx-auto">
          ...
          /* LOGIN CARD */
          <div className="bg-zinc-900/40 border border-zinc-800/60 backdrop-blur-md rounded-3xl p-6 md:p-8 text-left max-w-md mx-auto shadow-2xl relative">
            <h2 className="text-xl font-bold text-white tracking-tight mb-2">Welcome Back</h2>
            <p className="text-xs text-zinc-400 mb-6">Enter your username and password to access your dashboard.</p>
            ...
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 focus:border-pink-500 focus:outline-none rounded-xl pl-11 pr-4 py-3 text-sm text-white placeholder-zinc-600 transition-colors"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 focus:border-pink-500 focus:outline-none rounded-xl pl-11 pr-11 py-3 text-sm text-white placeholder-zinc-600 transition-colors"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-pink-500/20 active:scale-98 flex items-center justify-center gap-2 cursor-pointer text-sm"
              >
            ...
            <div className="mt-6 pt-5 border-t border-white/5 text-center text-xs text-zinc-400">
              ...
              <button 
                ...
                className="text-pink-500 font-bold hover:underline bg-none border-none p-0 cursor-pointer"
              >
                Create an account
              </button>
            </div>
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/60 backdrop-blur-md rounded-3xl p-6 md:p-8 text-left max-w-lg mx-auto shadow-2xl relative">
                  ...
                  {s < 4 && (
                    <div
                      className={`h-0.5 flex-1 mx-2.5 rounded-full transition-all duration-500 ${
                        signUpStep > s ? "bg-gradient-to-r from-pink-500 to-purple-600" : "bg-white/5"
                      }`}
                    />
                  )}
                </div>
              ...
              {signUpStep === 1 && (
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-300">
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-1">Get started by filling out your base hacker profile credentials.</p>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-white/10 focus:border-pink-500 focus:outline-none rounded-xl pl-9 pr-4 py-2.5 text-xs text-white placeholder-zinc-600 transition-colors"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white/5 border border-white/10 focus:border-pink-500 focus:outline-none rounded-xl pl-9 pr-9 py-2.5 text-xs text-white placeholder-zinc-600 transition-colors"
                        />
                        <button
                          type="button"
                          onClick={() => setShowPassword(!showPassword)}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                      <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1">College</label>
                      <input
                        type="text"
                        placeholder="e.g. MIT"
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Course</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-wider mb-1">Year of Study</label>
                      <input
                        type="text"
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-300">
                  ...
                  <div className="space-y-5 px-1">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] text-zinc-400 font-semibold tracking-wider uppercase">Self-Evaluation</span>
                      <span className="text-xl font-black text-pink-500 bg-pink-500/10 px-2.5 py-0.5 rounded-lg border border-pink-500/20">
                    ...
                    <div className="relative group pt-2 pb-1">
                      <input
                        ...
                        className="w-full h-1.5 bg-white/5 border border-white/10 rounded-lg appearance-none cursor-pointer accent-pink-500 outline-none"
                      />
                      <div className="flex justify-between text-[9px] text-zinc-500 font-medium px-0.5 mt-1.5">
                        <span>Beginner</span>
                    ...
                    <div className="p-3.5 rounded-xl bg-white/5 border border-white/5 text-center transition-all duration-300">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white/5 border border-white/10 focus:border-pink-500 focus:outline-none rounded-xl px-3 py-2 text-xs text-white placeholder-zinc-600 transition-colors"
                      />
                    </div>
              ...
              <div className="flex gap-4 mt-6 pt-5 border-t border-white/5">
                {signUpStep > 1 ? (
                  <button
                    ...
                    className="flex-1 py-2.5 px-4 rounded-xl border border-white/10 text-white font-medium hover:bg-white/5 transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer text-xs"
                  >
                ...
                <button
                  ...
                  className={`flex-1 py-2.5 px-4 rounded-xl font-bold transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer text-xs ${
                    signUpStep === 2 && techStack.length === 0
                      ...
                      : signUpStep === 4
                      ? "bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-600 text-white shadow-lg shadow-pink-500/20 active:scale-95"
        ...
        {/* Footer */}
        <div className="text-[10px] text-zinc-600 font-medium tracking-widest uppercase pt-2">
